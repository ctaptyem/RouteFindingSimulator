...
def plot_node_count_v_time():
    df = pd.read_csv('/home/andrei/Dev/RouteFindingSimulator/measurements/first_attempt_data.csv', index_col=False)
    ...
    plt.tight_layout()
    plt.savefig('/home/andrei/Dev/RouteFindingSimulator/plots/node_count_v_time.png', dpi=300, bbox_inches='tight')
